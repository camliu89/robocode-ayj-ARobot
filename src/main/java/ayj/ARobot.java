...
public class ARobot extends Robot {
  ...
  /**
   * Overrides event when a robot is scanned.
   * Part of the code taken from : "http://robocoderepository.com/BotFiles/2638/Newbie.java"
   * @param e enemy.
   */
  @Override
  ...
  /**
   * Overrides an event when my robot is hit by a bullet.
   * Move back 200 pixels.
   * @param event event.
   */
  @Override
