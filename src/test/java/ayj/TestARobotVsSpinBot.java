 ...
 * This test simply verifies that ARobot always beats SpinBot.
 * 
 ...
 */
public class TestARobotVsSpinBot extends RobotTestBed {

  /**
   * Specifies that SpinBot and ARobot are to be matched up in this test case.
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.SpinBot,ayj.ARobot";
  }
  ...
  /**
   * The actual test, which asserts that ARobot has won every round against SpinBot.
  ...
  public void onBattleCompleted(BattleCompletedEvent event) {
    ...
    assertTrue("Check ARobot winner", ARobotResults.getFirsts() > getNumRounds() * 0.1);
  }  
}
