 ...
 * This test simply verifies that ARobot always beats Tracker.
 * 
 ...
 */
public class TestARobotVsTracker extends RobotTestBed {

  /**
   * Specifies that Tracker and ARobot are to be matched up in this test case.
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.Tracker,ayj.ARobot";
  }
  ...
  /**
   * The actual test, which asserts that ARobot has won every round against Tracker.
