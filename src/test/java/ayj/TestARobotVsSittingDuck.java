 ...
 * This test simply verifies that ARobot always beats SittingDuck.
 * 
 ...
 */
public class TestARobotVsSittingDuck extends RobotTestBed {

  /**
   * Specifies that SittingDuck and ARobot are to be matched up in this test case.
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "sample.SittingDuck,ayj.ARobot";
  }
  ...
  /**
   * The actual test, which asserts that ARobot has won every round against SittingDuck.
