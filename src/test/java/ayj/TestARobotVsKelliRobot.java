 ...
 */
public class TestARobotVsKelliRobot extends RobotTestBed {

  /**
   * Specifies that KellieRobot and ARobot are to be matched up in this test case.
   * @return The comma-delimited list of robots in this match.
   */
  @Override
  public String getRobotNames() {
    return "kkc.KellieRobot,ayj.ARobot";
  }
  ...
  /**
   * The actual test, which asserts that ARobot has won every round against KellieRobot.
